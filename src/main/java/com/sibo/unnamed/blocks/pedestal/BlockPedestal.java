...
import com.sibo.unnamed.common.UnnamedGuiHandler;
...
public class BlockPedestal extends TileEntityBlock<TileEntityPedestal>{
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, @Nullable ItemStack heldItem, EnumFacing side, float hitX, float hitY, float hitZ){
		if(!world.isRemote){
			...
			if(!player.isSneaking()){
				...
				player.openGui(Unnamed.instance, UnnamedGuiHandler.PEDESTAL, world, pos.getX(), pos.getY(), pos.getZ());
			}
		}
		return true;
	}
