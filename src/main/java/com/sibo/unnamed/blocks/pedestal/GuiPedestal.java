...
public class GuiPedestal extends GuiContainer{
	...
	private static final ResourceLocation BG_TEXTURE = new ResourceLocation(Unnamed.modId, "textures/gui/pedestal.png");
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
		String name = I18n.format(UnnamedBlocks.pedestal.getUnlocalizedName() + ".name");
