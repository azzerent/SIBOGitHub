...
public class BlockMegaFurnace extends TileEntityBlock{

	public static final PropertyBool IS_SMELTING = PropertyBool.create("is_smelting");
	
	
	public BlockMegaFurnace() {
	...
	public Class<TileEntityMegaFurnace> getTileEntityClass() {
		return TileEntityMegaFurnace.class;
	}

	@Override
	public TileEntityMegaFurnace createTileEntity(World world, IBlockState state) {
